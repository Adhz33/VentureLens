...
const presets = [
  ...
  { label: 'Last year', getValue: () => ({ from: startOfYear(subMonths(new Date(), 12)), to: endOfMonth(subMonths(new Date(), 1)) }) },
  { label: 'All time', getValue: () => ({ from: new Date('2020-01-01'), to: new Date() }) },
];
